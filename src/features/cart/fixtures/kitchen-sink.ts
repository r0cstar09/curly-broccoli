...
const photoshop = {
	...
	quantity: 5,
	productVariantId: 'photoshop-default',
	productVariant: {
		id: 'photoshop-default',
		name: 'Default',
		stock: 999,
		options: {},
		product: {
			...
			variants: [{ id: 'photoshop-default', name: 'Default', stock: 999, options: {} }],
...
export const kitchenSinkFixture: Cart = {
	items: [
		...
		{ ...photoshop, quantity: 1 },
		{
			...
			quantity: 1,
			productVariantId: 'illustrator-default',
			productVariant: {
				...
				product: {
					...
					updatedAt: '2024-09-20T20:09:51.523Z',
					deletedAt: null,
					variants: [{ id: 'illustrator-default', name: 'Default', stock: 999, options: {} }],
				},
			},
		},
	],
