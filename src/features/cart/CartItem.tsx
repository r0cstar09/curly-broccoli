	...
	return (
		<Show when={deleteMutation.isIdle}>
			<div class={`flex items-start gap-8 ${props.class ?? ''}`}>
				...
				<button
					type="button"
					class="-my-2 self-end p-2 text-theme-accent-400 hover:text-theme-accent-300"
